...
import com.co.AutomatizacionPragma.userinterfaces.HomePage;
...
public class Verify implements Question<Boolean> {
    ...
    public Verify(List<ConstructorVAR> constructorVars) {
        this.constructorVars = constructorVars;
    }

    public static Verify createUser(List<ConstructorVAR> constructorVars) {
        return new Verify(constructorVars);
    }
