...
public class Validate implements Question<Boolean> {
    ...
    public Validate(List<ConstructorVAR> constructorVars) {
        this.constructorVars = constructorVars;
    }

    public static Validate shoppingcart(List<ConstructorVAR> constructorVars) {
        return new Validate(constructorVars);
    }
